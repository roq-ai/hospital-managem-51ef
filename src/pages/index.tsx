...
function HomePage() {
  ...
  return (
    <>
      <Head>
        <title>{`Hospital Management  v3`}</title>

        <meta
          name="description"
          content="Welcome to Hospital Management v3 - Your comprehensive solution for efficient patient record handling, billing, medication tracking, and appointment scheduling. Ensuring seamless healthcare service delivery."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to Hospital Management v3 - Your comprehensive solution for efficient patient record handling, billing, medication tracking, and appointment scheduling. Ensuring seamless healthcare service delivery.`}
            </Text>
            <Box
